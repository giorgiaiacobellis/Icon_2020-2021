...
def askStessoGenere(titolo1:str, titolo2:str):
    ...
    rispostaUtente=input("Digitare how per la spiegazione: ")
    if (rispostaUtente.lower()=="how"):
       print("askStessoGenere("+titolo1+","+titolo2+") <=> "+titolo1+"_"+titolo2+" and  "+titolo1+"_"+primoGenere+ " and "+titolo2+"_"+secondoGenere+" and generiUguali("+primoGenere+","+secondoGenere+")")

       rispostaUtente=input("Digitare 'how i' specificando in i il numero dell'atomo per ulteriori informazioni: ")
       if(rispostaUtente.lower()=='how 1'):
           print(titolo1+"_"+primoGenere+" is", risposte.get(1))
           rispostaUtente=input("Digitare 'how i' specificando in i il numero dell'atomo per ulteriori informazioni: ")
           if(rispostaUtente.lower() =="how 2"):
               print(titolo2+"_"+secondoGenere+") is ",risposte.get(2))       
               rispostaUtente=input("Digitare 'how i' specificando in i il numero dell'atomo per ulteriori informazioni: ")
               if(rispostaUtente=="how 3"): 
                   print("generiUguali("+titolo1+","+titolo2+" <=> "+primoGenere+"_"+secondoGenere+" is", risposte[3])       
               else:
                   print("Errore di digitazione")
           else: 
               print("Errore di digitazione")
           ...
           if(rispostaUtente.lower() =="how 2"):
               ...
               if(rispostaUtente.lower()=="how 1"):
                   ...
                   if(rispostaUtente=="how 3"): 
                       print("stessoGenere("+titolo1+","+titolo2+") <=> "+primoGenere+"_"+secondoGenere+" is", risposte[3])       
                   else:
                       print("Errore di digitazione")
                
           else:
               if(rispostaUtente.lower() =="how 3"):
                   print("stessoGenere("+titolo1+","+titolo2+") <=>  generiUguali("+primoGenere+","+secondoGenere+") is", risposte[3])
                   rispostaUtente=input("Digitare 'how i' specificando in i il numero dell'atomo per ulteriori informazioni: ")
                   if(rispostaUtente.lower() =="how 2"):
                       print("SecondaCorrispondenza("+titolo2+") <=> corrispondenzaEsiste("+titolo2+" , " + secondoGenere+ ") is ", risposte.get(2))       
                       rispostaUtente=input("Digitare 'how i' specificando in i il numero dell'atomo per ulteriori informazioni: ")
